...
public class BookMarks {
  ...
  /*      paragraphList.forEach((paragraph) -> {
            ...
            bookmarkList.forEach((bookmark) -> {
            	NamedNodeMap attributes = bookmark.getDomNode().getAttributes();
                if(attributes != null) {
                    // Get the colFirst and colLast attributes. If both - for
                    // now - are found, then we are dealing with a bookmarked
                    // cell.
                	Node colFirstNode = attributes.getNamedItem("w:colFirst");
                	Node colLastNode = attributes.getNamedItem("w:colLast");
                    if(colFirstNode != null && colLastNode != null) {
                        ...
                        int firstColIndex = Integer.parseInt(colFirstNode.getNodeValue());
                        int lastColIndex = Integer.parseInt(colLastNode.getNodeValue());
