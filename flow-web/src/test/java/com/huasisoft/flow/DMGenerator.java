...
public class DMGenerator {
    ...
    public static void main(String[] args) {
        ...
        dsc.setSchemaName("FLOW");
        mpg.setDataSource(dsc);

        // TODO 包配置
        PackageConfig pc = new PackageConfig();
        //pc.setModuleName(scanner("模块名"));
        pc.setParent("com.huasisoft.flow.business");
        pc.setEntity("entity");
        ...
        focList.add(new FileOutConfig("/templates/mapper.xml.ftl") {
            ...
            public String outputFile(TableInfo tableInfo) {
                // 自定义输出文件名称
                return projectPath + "/src/main/resources/mapper/dm"
        ...
        cfg.setFileCreate(new IFileCreate() {
			...
			public boolean isCreate(ConfigBuilder configBuilder, FileType fileType, String filePath) {
				...
				if (FileType.ENTITY==fileType||FileType.MAPPER==fileType||FileType.XML==fileType||FileType.OTHER==fileType){
